---
name: add-gifts
description: Add or update gift entries in the Trippel navnefest wishlist. Use when a user asks to add, remove, revise, research, categorize, price, link, or attach an image to a wishlist gift in this repository.
---
